              ...
              children: <Widget>[
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.black, // Change "grey" to the color you want
                  ),
            ...
            Row(
              ...
              children: <Widget>[
                ElevatedButton(
                  child: Text('Back'),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.black87, // Change "grey" to the color you want
                  ),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                primary: Colors.black, // Change "blue" to the color you want
              ),
              onPressed: () {
                Navigator.push(
                    context,
