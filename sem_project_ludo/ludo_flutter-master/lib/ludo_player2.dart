...
import 'package:ludo_flutter/widgets/pawn_widget2.dart';
...
class LudoPlayer {
  ...
  void movePawn(int index, int step) async {
    pawns[index] = PawnWidget2(index, type, step: step, highlight: false);
  }
  ...
  void highlightPawn(int index, [bool highlight = true]) {
    ...
    pawns.insert(index, PawnWidget2(index, pawn.type, highlight: highlight, step: pawn.step));
  }
