...
///Widget for the pawn
class PawnWidget2 extends StatelessWidget {
  final int index;
  final LudoPlayerType type;
  final int step;
  final bool highlight;

  const PawnWidget2(this.index, this.type, {Key? key, this.highlight = false, this.step = -1}) : super(key: key);
          ...
          Consumer<two_player>(
            builder: (context, provider, child) => GestureDetector(
              onTap: () {
                ...
                context.read<two_player>().move(type, index, step);
              },
              child: Container(
